    ...
    public class BlogController : ControllerBase
    {
        ...
        public async Task<ActionResult<Blog>> Create(BlogCreate blogCreate)
        {
            ...
            if (blogCreate.PhotoId.HasValue)
            {
                ...
                {
                    return BadRequest("Imaginea nu a fost incarcata.");
                }
            }
        ...
        public async Task<ActionResult<int>> Delete(int blogId)
        {
            ...
            if (foundBlog == null) return BadRequest("Postarea nu exista.");
            ...
            {
                return BadRequest("Acces limitat - Nu esti creatorul acestei postari.");
            }
