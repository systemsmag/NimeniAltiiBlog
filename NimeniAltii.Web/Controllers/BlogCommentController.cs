...
using NimeniAltii.Models.BlogComment;
...
namespace NimeniAltii.Web.Controllers
{
    ...
    public class BlogCommentController : ControllerBase
    {
        ...
        public async Task<ActionResult<int>> Delete(int blogCommentId)
        {
            ...
            if (foundBlogComment == null) return BadRequest("Acest comentariu nu exista.");
            ...
            {
                return BadRequest("Acest comentariu nu a fost creat de utilizatorul curent.");
            }
        }
